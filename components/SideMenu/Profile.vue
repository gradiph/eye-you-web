                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-center">
                                        <figure class="figure text-center">
                                            <img src="http://127.0.0.1:8000/images/achievement-login.png" class="figure-img img-fluid rounded shadow" alt="Berhasil masuk!" />
                                            <figcaption class="figure-caption text-center text-primary">Berhasil masuk!</figcaption>
                                        </figure>
                                    </div>
                                    <div class="col-6 text-center">
                                        <figure class="figure text-center">
                                            <img src="http://127.0.0.1:8000/images/achievement-mode-number.png" class="figure-img img-fluid rounded shadow" alt="Selesaikan mode angka!" />
                                            <figcaption class="figure-caption text-center text-primary">Selesaikan mode angka!</figcaption>
                                        </figure>
                                    </div>
                                    <div class="col-6 text-center">
                                        <figure class="figure text-center">
                                            <img src="http://127.0.0.1:8000/images/achievement-score-500.png" class="figure-img img-fluid rounded shadow" alt="Capai skor 500!" />
                                            <figcaption class="figure-caption text-center text-primary">Capai skor 500!</figcaption>
                                        </figure>
                                    </div>
                                    <div class="col-6 text-center">
                                        <figure class="figure text-center">
                                            <img src="http://127.0.0.1:8000/images/achievement-mode-shape.png" class="figure-img img-fluid rounded shadow" alt="Selesaikan mode bentuk!" />
